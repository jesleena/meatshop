...
class marinated_page extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var cartitems = context.watch<ProductProvider>().cart;
    var marinatedd = context.watch<ProductProvider>().marinated;
    return Scaffold(
      appBar: AppBar(
        title: Text("Marinated ",style: Theme.of(context).textTheme.displayLarge),
        actions: [
          IconButton(
      ...
      body: GridView.count(
        ...
        children: List.generate(4, (index) {
          final currentProduct = marinatedd[index];
          return
            Card(
              // height: 400,
